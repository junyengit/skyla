...
const SkylaData = (() => {
  ...
  const DEFAULTS = {
    ...
    addons: [
      { id: 'matcha',   name: 'Ceremonial Matcha Latte',  emoji: '🍵', price: 12, active: true },
      { id: 'pourover', name: 'Single-Origin Pour Over',  emoji: '☕', price: 10, active: true },
      { id: 'hojicha',  name: 'Iced Matcha Hojicha Latte',emoji: '🧋', price: 13, active: true },
      { id: 'coldbrew', name: 'Iced Mocha Cold Brew',     emoji: '🍫', price: 11, active: true },
    ],
    cafeMenu: {
      matcha: [
        { id: 'm1', name: 'Ceremonial Matcha Latte',  price: 12, desc: 'Stone-ground ceremonial grade matcha with oat or whole milk. Hot or iced.', tags: 'Hot · Iced, Oat · Whole Milk, Vegan Option', active: true },
        ...
        { id: 'm3', name: 'Iced Hojicha Latte',       price: 13, desc: 'Roasted Japanese green tea with house-made brown sugar syrup and oat milk.', tags: 'Iced Only, Low Caffeine', active: true },
      ...
      coffee: [
        { id: 'c1',  name: 'Single-Origin Pour Over',  price: 10, desc: 'Brewed to order through a Hario V60. Rotating small-batch roasters weekly.', tags: 'Hot · Iced, Rotating Weekly', active: true },
        { id: 'c2',  name: 'Iced Mocha Cold Brew',     price: 11, desc: '24-hour cold-steeped concentrate with Valrhona dark chocolate and oat milk.', tags: 'Iced Only, Vegan', active: true },
